package com.example.lesson74preferencescode;
...
public class PrefActivity extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CheckBoxPreference chb2 = new CheckBoxPreference(this);
        chb2.setKey("chb2");
        ...
        final CheckBoxPreference chb6 = new CheckBoxPreference(this);
        chb6.setKey("chb6");
        ...
        screen.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                if (chb2.isChecked() && listValue != null) {
                    if (listValue.equals("1"))
                        categ2.removePreference(chb6);
                    else
                        categ2.addPreference(chb6);
                }
                return false;
